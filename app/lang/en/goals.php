...
return [
		...
		'goal_1_nagative' => ':name is not meeting the goal for academic success, meaning they are earning a low grade in one or more of their classes. See the list below for details.',
...
',
		'goal_2_nagative' => ':name is not meeting the goal for daily attendance, meaning the number of missed classes is higher than the average at the school. See the chart below for details.',
...
',
		...
		'goal_3_nagative' => ':name  is not meeting the goal for punctuality, meaning the number of tardies is higher than the average at the school. See the chart below for details.',
		...
		'goal_4_nagative' => ':name  is not meeting the goal for positive behavior, meaning the number of infractions is higher than the average at the school. See the chart below for details.',
