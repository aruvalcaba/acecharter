...
$helper->tag('main') .
	$helper->tag('section',['id'=>'service','class'=>'home-section text-center']) .
		$helper->tag('div',['class'=>'container']) .  
            ...
            $helper->tag('div',['class'=>'row p-b-15']) . $helper->a('/roster/upload', $data['upload_roster'] , array('class'=>'btn btn-large btn-danger')) . $helper->tag('/div') . '(ACE Code, Student Name, Teacher)' .
