<?php namespace TT\DailyAttendance\Upload\Domain;
...
class UploadService extends AbstractService
{
    ...
    public function getData()
    {
        return [
                ...
                'daily_attendance_label'=>['val'=>$this->getMsg('constants.daily_attendance')],
                'daily_attendance_input'=>['type'=>'file','name'=>'daily_attendance','attribs'=>['class'=>'form-control','id'=>'dailyattendance','accept'=>'.csv']]
               ];
    }
}
